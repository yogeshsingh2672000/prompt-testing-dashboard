    ...
    return (
        <div className="flex flex-col md:grid md:grid-cols-12 gap-4 md:gap-2 rounded-2xl relative group hover:bg-zinc-50 dark:hover:bg-white/[0.02] transition-all p-4 border border-transparent md:border-dashed md:hover:border-zinc-200 dark:md:hover:border-zinc-800">
            ...
            <div className="md:col-span-5 space-y-2">
                <label className="block text-xs font-black text-zinc-400 dark:text-zinc-500 uppercase tracking-widest ml-1">Input Context</label>
                <textarea
                    value={tc.input}
            ...
            <div className="md:col-span-5 space-y-2">
                <label className="block text-xs font-black text-zinc-400 dark:text-zinc-500 uppercase tracking-widest ml-1">Expected Output</label>
                <textarea
